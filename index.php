...
//educations
$select_educations = "SELECT * FROM educations WHERE education_status=1 ";
$select_educations_result = mysqli_query($db_connect, $select_educations);

//Abouts
$select_abouts = "SELECT * FROM abouts WHERE about_status=1";
...
//areas
$select_areas = "SELECT * FROM areas WHERE area_status=1";
$select_areas_result = mysqli_query($db_connect, $select_areas);
$after_assoc_areas = mysqli_fetch_assoc($select_areas_result);
...
<head>
    ...
    <title>Kuffa - Personal Portfolio with Template</title>
    ...
    <main>
        ...
        <section id="about" class="about-area primary-bg pt-120 pb-120">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img  width="400" src="uploads/areas/<?= $after_assoc_areas['area']?>" title="me-01" alt="me-01">
                        </div>
                    </div>
                                ...
                                <div class="progressWrapper">
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s"
                                            ...
                                            aria-valuenow="<?=$education['percentage']?>" aria-valuemin="0"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="icon_box_01 wow fadeInLeft" data-wow-delay="0.2s">
                            <div class="about-img">
                                <img alt="" width="100" src="uploads/projects/<?=$project['image']?>">
                            </div>
                            <h3><?=$project['title']?></h3>
        ...
        <section class="fact-area">
            <div class="container">
                ...
                <?php foreach($select_facts_result as $key=>$fact){ ?>
                        ...
                        <div class="testimonial-active">
                            ...
                            <div class="single-testimonial text-center">
                                <div class="testi-avatar">
                                    <img width="100" src="uploads/testimonials/<?=$testimonial['image']?>" alt="img">
                                </div>
           ...
           <?php foreach($select_brand_result as $brand){ ?>
                <div class="col-xl-2">
                  <div class="single-brand">
                            <img width="50" src="uploads/brands/<?=$brand['image']?>" alt="img">
                        </div>
                     </div>
                  <?php }?> 
                 </div>
